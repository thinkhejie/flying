...
public class DemoTester2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		properties.put("STORE_PATH", "/Users/hejie/flyingmq");
		properties.put("MAPED_FILE_SIZE", mapedFileSizeCommitLog);
	...
	/*
	private static PullConsumer consume(String queue, String topic) {
		KeyValue properties = new DefaultKeyValue();
		properties.put("FLUSH_INTERVAL_CONSUME_QUEUE", flushIntervalConsumeQueue);
		properties.put("FLUSH_CONSUME_QUEUE_LEASTPAGES", flushConsumeQueueLeastPages);
		properties.put("FLUSH_CONSUME_QUEUE_THOROUGHINTERVAL", flushConsumeQueueThoroughInterval);
		PullConsumer pullConsumer = new FlyingPullConsumer(properties);
		pullConsumer.attachQueue(queue, Collections.singletonList(topic));
		return pullConsumer;
	}*/
}
